...
The sinking of the RMS Titanic is one of
...
Although there was some element of luck involved
 in surviving the sinking,some groups of people
 were more likely to survive than others,
such as women, children, and the upper-class.

In this challenge, we ask you to complete the
analysis of what sorts of people were likely to survive.
In particular, we ask you to apply the tools
of machine learning to predict
...
1) training set (train.csv)   891 Rows x 12 Cols
2) test set (test.csv)        418 Rows x 11 Cols
...
print(  "\n\nTraining Data: \n" , train.columns  ) #12 columns
#OUTPUT
#Index(['PassengerId', 'Survived', 'Pclass', 'Name', 'Sex', 'Age', 'SibSp',
#       'Parch', 'Ticket', 'Fare', 'Cabin', 'Embarked'],
#      dtype='object')

print(  "\n\nTesting Data:\n" , test.columns  )  #11 columns
#OUTPUT
